// Validación para formulario de Cambio de Contraseña
...
const formulario = document.querySelector('.formulario-cambio-contrasena__form');
...
const mostrar_errores = (error, campo = null) => {
    ...
    if (campo) {
        ...
        const nuevaPass = document.querySelector('input[name="nuevaContrasena"]');
        const confirmPass = document.querySelector('input[name="confirmarContrasena"]');
        if (nuevaPass) nuevaPass.classList.add("error");
        if (confirmPass) confirmPass.classList.add("error");
    }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    formulario.addEventListener('submit', function (e) {
        ...
        const pass1 = document.querySelector('input[name="nuevaContrasena"]');
        const pass2 = document.querySelector('input[name="confirmarContrasena"]');
